...
class _HomePageState extends State<HomePage> {
  final _controllerConfettin = ConfettiController();
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        Scaffold(
          bottomNavigationBar: CurvedNavigationBar(
            ...
            items: [
              Icon(
                Icons.home,
                color: Color.fromARGB(255, 99, 25, 210),
              ),
              Icon(
                Icons.settings,
                color: Color.fromARGB(255, 99, 25, 210),
            ...
            onTap: (index) => {
              if (index == 2)
                {
                  _controllerConfettin.play(),
                }
              else
                {_controllerConfettin.stop()}
            },
        ...
        ConfettiWidget(
          confettiController: _controllerConfettin,
          blastDirection: pi / 2,
          gravity: 0.1,
